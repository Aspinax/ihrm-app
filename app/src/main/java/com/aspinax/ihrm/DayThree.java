...
public class DayThree extends AppCompatActivity {
    ...
    private static final String TAG = "DayThree";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gotoattendance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(DayThree.this, MainActivity.class);
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            final attendeeAdapter attendeeAdapt = new attendeeAdapter(DayThree.this, attendanceList, 17);
                                ...
                                nextQuery.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                                    ...
                                    public void onComplete(@NonNull Task<QuerySnapshot> t) {
                                        if (t.isSuccessful()) {
                                            ...
                                            if(t.getResult().size() - 1 > 0) {
                                                ListView attendanceListView = findViewById(R.id.attendeeList);
                                                final attendeeAdapter attendeeAdapter = new attendeeAdapter(DayThree.this, attendanceList, 17);
        ...
        launchqr.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                IntentIntegrator integrator = new IntentIntegrator(DayThree.this);
                        ...
                        if (task.isSuccessful()) {
                            ...
                            if (document.exists()) {
                                ...
                                if (!document.getBoolean("checkIn17")) {
                                    ...
                                    checkInInfo.put("checkIn17", true);
                                    checkInInfo.put("checkIn17Time", time);
                                    db.collection("delegates").document(document.getString("unique_id")).update(checkInInfo);
                                }
                            } else {
                                /* id not found */
                                Toast.makeText(DayThree.this, "Unique ID not found.", Toast.LENGTH_LONG).show();
                            }
                        } else {
                            /* error */
