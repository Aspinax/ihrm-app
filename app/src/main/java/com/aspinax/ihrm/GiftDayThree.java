...
public class GiftDayThree extends AppCompatActivity {

    FirebaseFirestore db = FirebaseFirestore.getInstance();
    private static final String TAG = "GiftDayThree";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gift_day_three);
        ...
        gotoattendance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(GiftDayThree.this, MainActivity.class);
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            final attendeeAdapter attendeeAdapt = new attendeeAdapter(GiftDayThree.this, attendanceList, 17);
                                ...
                                nextQuery.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                                    ...
                                    public void onComplete(@NonNull Task<QuerySnapshot> t) {
                                        if (t.isSuccessful()) {
                                            ...
                                            if(t.getResult().size() - 1 > 0) {
                                                ListView attendanceListView = findViewById(R.id.attendeeList);
                                                final attendeeAdapter attendeeAdapter = new attendeeAdapter(GiftDayThree.this, attendanceList, 17);
        ...
        launchqr.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                IntentIntegrator integrator = new IntentIntegrator(GiftDayThree.this);
