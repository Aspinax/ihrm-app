...
public class GiftDayFour extends AppCompatActivity {

    FirebaseFirestore db = FirebaseFirestore.getInstance();
    private static final String TAG = "GiftDayFour";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gift_day_four);
        ...
        gotoattendance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(GiftDayFour.this, MainActivity.class);
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            final attendeeAdapter attendeeAdapt = new attendeeAdapter(GiftDayFour.this, attendanceList, 18);
                                ...
                                nextQuery.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                                    ...
                                    public void onComplete(@NonNull Task<QuerySnapshot> t) {
                                        if (t.isSuccessful()) {
                                            ...
                                            if(t.getResult().size() - 1 > 0) {
                                                ListView attendanceListView = findViewById(R.id.attendeeList);
                                                final attendeeAdapter attendeeAdapter = new attendeeAdapter(GiftDayFour.this, attendanceList, 18);
        ...
        launchqr.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                IntentIntegrator integrator = new IntentIntegrator(GiftDayFour.this);
                        ...
                        if (task.isSuccessful()) {
                            ...
                            if (document.exists()) {
                                ...
                                if (!document.getBoolean("checkIn18")) {
                                    ...
                                    checkInInfo.put("gift18", true);
                                    checkInInfo.put("gift18Time", time);
                                    db.collection("delegates").document(document.getString("unique_id")).update(checkInInfo);
                                }
                            } else {
                                /* id not found */
                                Toast.makeText(GiftDayFour.this, "Unique ID not found.", Toast.LENGTH_LONG).show();
                            }
                        } else {
                            /* error */
