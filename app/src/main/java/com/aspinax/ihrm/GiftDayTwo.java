...
public class GiftDayTwo extends AppCompatActivity {

    FirebaseFirestore db = FirebaseFirestore.getInstance();
    private static final String TAG = "GiftDayTwo";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gift_day_two);
        ...
        gotoattendance.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(GiftDayTwo.this, MainActivity.class);
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            final attendeeAdapter attendeeAdapt = new attendeeAdapter(GiftDayTwo.this, attendanceList, 16);
                                ...
                                nextQuery.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                                    ...
                                    public void onComplete(@NonNull Task<QuerySnapshot> t) {
                                        if (t.isSuccessful()) {
                                            ...
                                            if(t.getResult().size() - 1 > 0) {
                                                ListView attendanceListView = findViewById(R.id.attendeeList);
                                                final attendeeAdapter attendeeAdapter = new attendeeAdapter(GiftDayTwo.this, attendanceList, 16);
        ...
        launchqr.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                IntentIntegrator integrator = new IntentIntegrator(GiftDayTwo.this);
                        ...
                        if (task.isSuccessful()) {
                            ...
                            if (document.exists()) {
                                ...
                                if (!document.getBoolean("checkIn16")) {
                                    ...
                                    checkInInfo.put("gift16", true);
                                    checkInInfo.put("gift16Time", time);
                                    db.collection("delegates").document(document.getString("unique_id")).update(checkInInfo);
                                }
                            } else {
                                /* id not found */
                                Toast.makeText(GiftDayTwo.this, "Unique ID not found.", Toast.LENGTH_LONG).show();
                            }
                        } else {
                            /* error */
